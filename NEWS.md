...
* New `roll_median`, `roll_any`, `roll_all` functions for computing rolling medians, any, and all, respectively, of time-series data ([#4](https://github.com/jjf234/roll/issues/4), [#14](https://github.com/jjf234/roll/issues/14))
