...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const bool& >::type na_restore(na_restoreSEXP);
    Rcpp::traits::input_parameter< const std::string& >::type parallel_for(parallel_forSEXP);
    __result = Rcpp::wrap(roll_scale(data, width, weights, center, scale, min_obs, complete_obs, na_restore, parallel_for));
    return __result;
END_RCPP
}
// roll_cov
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const bool& >::type na_restore(na_restoreSEXP);
    Rcpp::traits::input_parameter< const std::string& >::type parallel_for(parallel_forSEXP);
    __result = Rcpp::wrap(roll_vif(data, width, weights, center, scale, min_obs, complete_obs, na_restore, parallel_for));
    return __result;
END_RCPP
}
